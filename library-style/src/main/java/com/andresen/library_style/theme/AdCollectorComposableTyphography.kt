...
val LocalAdCollectorTypography = staticCompositionLocalOf<AdCollectorTypography> {
    error("Overwatch Typography not initialized!")
}

internal fun createAdCollectorSansTypography() = createTypography(adCollectorSansFamily)

internal fun createTypography(fontFamily: FontFamily) = AdCollectorTypography(
...
private val adCollectorSansFamily: FontFamily
    get() = FontFamily(
        Font(R.font.sans),
...
@Immutable
data class AdCollectorTypography(
